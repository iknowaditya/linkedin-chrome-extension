      ...
      <div className="bg-gray-50 rounded-lg shadow-lg w-[44rem] p-6">
        {userResponse.length > 0 && (
          <div className="flex flex-col gap-4 mb-6 text-xl overflow-y-auto">
            <div className="self-end max-w-[70%]">
              <p className="p-3 text-gray-600 bg-[#dfe1e7] rounded-lg break-words">
                {userResponse}
              </p>
            </div>

            <div className="self-start max-w-[70%]">
              <p className="p-3 text-gray-600 bg-[#dbeafe] rounded-lg break-words">
                {aiResponse}
              </p>
            </div>
          </div>
        ...
        <div>
          <input
            ...
            className="w-full outline-none border border-gray-300 placeholder:text-gray-400 px-4 py-3 text-gray-800 rounded-lg text-xl"
          />
        </div>
        ...
        {userResponse.length > 0 ? (
          <div className="mt-6 flex justify-end items-center space-x-3">
            <button
              className="flex justify-between items-center space-x-2 p-2 bg-[#f9fafb] text-[#666D80] border border-[#666D80] text-xl rounded-md transition duration-200 ease-in-out hover:bg-[#e5e7eb] hover:text-[#4B5563]"
              onClick={handleInsert}
            >
              <img src={insertIcon} alt="logo" className="h-4 w-4" />
              <span>Insert</span>
            </button>
            <button className="flex justify-between items-center border border-transparent space-x-2 px-4 py-2 bg-blue-500 text-white text-xl rounded-md transition duration-200 ease-in-out hover:bg-blue-600">
          ...
          <div className="mt-6 flex justify-end">
            <button
              className={`flex justify-between items-center space-x-2 px-5 py-2 text-xl rounded-md transition duration-200 ease-in-out
    ${
